# open-questions/overview — Open Questions Domain

Open-question pages track unresolved gaps, deferred work, and known future cleanup. These are not automatically prioritized tasks; they preserve context so future work starts from known state.
