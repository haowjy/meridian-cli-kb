# operations/overview — Operations Domain

Operations pages cover how to run, configure, diagnose, and recover Meridian in practice.

## Pages

- [health-checks.md](health-checks.md) — Doctor flow, orphan reconciliation, background scan cache, pruning, and live-spawn warnings.
- [session-archive-pruning.md](session-archive-pruning.md) — Explicit, dry-run-first removal of retired runner-history files.
