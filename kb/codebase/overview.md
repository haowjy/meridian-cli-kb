...
- [session-operations.md](session-operations.md) — `session log / search / export`: compaction segments, transcript extraction workflow, and user-facing command guidance.
