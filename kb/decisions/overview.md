...
| [native-session-identity.md](native-session-identity.md) | Approved technical design for exact chat/native-key binding, run boundaries, and native-only conversation history; not implemented |
