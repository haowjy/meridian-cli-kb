...
| [native-session-identity.md](native-session-identity.md) | Settled native-key/history contract; unmerged enabling slices and bounded fresh-owner R1, with typed/public/final emission and tracked transports still unqualified |
| [native-source-argument-admission.md](native-source-argument-admission.md) | Late fresh-route C, adapter-owned scalar admission and redacted suppression; R2/G and installed runtime qualification remain open |
