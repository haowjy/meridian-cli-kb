...
| [native-session-identity.md](native-session-identity.md) | Settled native-key/history contract and source-selection policy; unmerged branch has accepted primary phase 1 only, with no qualified tracked transport or shipped cutover |
