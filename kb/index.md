...
- [architecture/native-transcript-reads.md](architecture/native-transcript-reads.md) — PR 2 as landed: one resolver and `NativeRead` reader, pN view labels, native-keyed FTS5 search projection (witness, `complete`, rebuild/status, measured cost)
