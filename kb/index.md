...
- [architecture/state-system/portable-history.md](architecture/state-system/portable-history.md) — File/ZIP history authority, bounded index initialization, native snapshot qualification gap, disposable projections, retention, and inert restore
