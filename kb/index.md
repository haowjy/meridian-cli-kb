...
- [architecture/legacy-native-import.md](architecture/legacy-native-import.md) — One-time exact import of legacy chat native keys: trigger, locking, recovery, candidate stores, OpenCode snapshot, deferral, report mode, and cost
