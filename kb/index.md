...
- [architecture/completion-drain-coordination.md](architecture/completion-drain-coordination.md) — settled composition-first Pi/resident completion target, transitive descendant authority, Pi private-work boundary, cleanup invariant, and phased cutover
