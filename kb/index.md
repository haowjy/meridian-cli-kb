...
- [architecture/state-system/portable-history.md](architecture/state-system/portable-history.md) — File/ZIP history authority, bounded index initialization, design-approved post-stop native snapshot contract (not implemented), disposable projections, retention, and inert restore
