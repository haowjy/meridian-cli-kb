...
- [lessons/verification-and-review-discipline.md](lessons/verification-and-review-discipline.md) — Five generalizable patterns from 11 review rounds: capability token consumption, wrong-gate tests, vacuous verification, diff-vs-run, convergence as a redesign signal
