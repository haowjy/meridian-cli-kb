...
- [concepts/model-resolution/aliases-and-routing.md](concepts/model-resolution/aliases-and-routing.md) — Mars alias entries, pattern fallback, identity/routing split, harness selection priority cascade
