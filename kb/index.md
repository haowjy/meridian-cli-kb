...
- [architecture/state-system/portable-history.md](architecture/state-system/portable-history.md) — File/ZIP history authority, disposable metadata/preview projection, exact identities, short reclaim serialization, and inert selective restore
