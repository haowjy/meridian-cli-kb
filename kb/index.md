...
- [architecture/state-system/portable-history.md](architecture/state-system/portable-history.md) — File/ZIP history authority, dirty-source SQLite projection, exact identities, verified retention, and inert selective restore
