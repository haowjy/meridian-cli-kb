...
|---|---|---|---|
| 2026-09-22, D96 | Settled; not implemented in Mars 0.14.1 | Explicit `mars sync --force` takes over the selected canonical self path and records installed ownership; default sync remains protective. | [Package management](decisions/package-management.md#d96-explicit-force-takes-over-a-selected-canonical-self-path-2026-09-22) |
...
| 2026-09-14, D-native-transcript-snapshot | Partially implemented on feature branch; qualified snapshot remains open | Keep stream evidence and atomically publish a separate canonical native snapshot; preserve raw OpenCode rows and immutable original capture binding. | [History storage](decisions/history-storage.md#d-native-transcript-snapshot) |
