...
|---|---|---|---|
| 2026-09-11, D-history-file-authority | Intended; implemented on unpushed feature branch | Retained transcripts and ZIPs are independently readable file authority; SQLite is a disposable one-way derived index. | [State](decisions/state.md#d-history-file-authority) |
