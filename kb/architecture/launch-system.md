...
For an OpenCode primary, dry-run describes the actual managed sequence—serve,
native inspection, HTTP bootstrap, and attach—rather than presenting a black-box
